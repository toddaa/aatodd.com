				...
				<div className="row h-100">
					<div className="col-12 col-md-9 offset-md-1">
						...
						<p>
							...
							I've developed a real love for single page web apps using frameworks such as React and Angular. 
						...
						<p>
							...
							I'm willing to share my methods and be open-minded to alternative methods too. 
